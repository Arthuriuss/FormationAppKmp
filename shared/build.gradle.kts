...
plugins {
    ...
    kotlin("plugin.serialization") version "2.4.0" //version kotlin
...
buildConfig {
    ...
    packageName("com.mma.formationappkmp")

    // Récupération sécurisée de la clé
    val weatherAPIKey = localProperties.getProperty("openweather.api.key") ?: ""
...
kotlin {
    ...
    androidLibrary {
       namespace = "com.mma.formationappkmp.shared"
...
compose.desktop {
    application {
        mainClass = "com.mma.formationappkmp.api.KtorWeatherApiKt"
    }
}