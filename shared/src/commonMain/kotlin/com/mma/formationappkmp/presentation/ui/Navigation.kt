package com.mma.formationappkmp.presentation.ui
...
import com.mma.formationappkmp.presentation.ui.screens.DetailScreen
import com.mma.formationappkmp.presentation.ui.screens.MainViewModel
import com.mma.formationappkmp.presentation.ui.screens.SearchScreen
    ...
    NavHost(
        ...
        composable<Routes.SearchRoute> {
            ...
            SearchScreen(
                ...
                onOpenWeather = { id ->
                    navHostController.navigate(Routes.DetailRoute(id = id))
                }
            )
        }
